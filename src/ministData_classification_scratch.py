...
def show_data(digits):
    ...
    plt.savefig("pics/minist_demo.png")
    plt.show()
...
def fine_tuning(model, param, datax, datay):
    ...
    val_score = cross_val_score(
        grid_search.best_estimator_, datax, datay, cv=sk, scoring="accuracy"
    )
...
class minist_model:
    ...
    def train(self, model, xtrain, ytrain):
        ...
        plt.savefig("pics/row_matrix.png")
        ...
        plt.savefig("pics/norms_matrix.png")
        # 保存模型
...
def run(model_name, task):
    ...
    if model_name == "svm":
        ...
        model_path = r"model/digits_svm.pkl"
        ...
        model_path = r"model/digits_SGD.pkl"
