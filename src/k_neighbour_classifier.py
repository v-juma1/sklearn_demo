...
def compare_model(x_train, y_train):
    ...
    # 带权重的k邻近值算法
    models.append(
        ("knn_weights", KNeighborsClassifier(n_neighbors=2, weights="distance"))
    )
    ...
    logger.info(result)
    # [('knn', 0.6971708090957165), ('knn_weights', 0.6547593865679534), ('knn_radius', 0.6466684294024325)]
...
def model_with_curve(x_train, y_train):
    ...
    plt.savefig("pics/KNeighbors_diabetes.png")
...
def model_with_bset_feature(x_train, y_train):
    ...
    logger.info(result)
    # [('knn', 0.6972501322051825), ('knn_weights', 0.674537281861449), ('knn_radius', 0.6466419883659439)]
