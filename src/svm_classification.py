...
def generate_data(random_state=0):
    x, y = make_blobs(
        n_samples=100, centers=3, random_state=random_state, cluster_std=0.8
    )
    return x, y
...
def rbf_model(x, y):
    ...
    plt.savefig("pics/rbf_model.png")
    ...
    plt.savefig("pics/rbf_model_gamma_0.01.png")
