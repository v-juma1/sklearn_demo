...
train = read_dataset('scikit-learn/data/titanic/train.csv')
...
def max_depth_score():
    ...
    plt.legend()
    plt.savefig("scikit-learn/log/max_depth_score.png")
...
def min_impurity_split_score():
    ...
    plt.legend()
    plt.savefig("scikit-learn/log/min_impurity_split_score.png")
...
def GridSearchCV_curve():
    ...
    def plot_curve(train_size, cv_result, xlabel):
        ...
        plt.plot(train_size,
                 ...
                 label="test score")
        plt.legend(loc="best")
        plt.savefig("scikit-learn/log/GridSearchCV_curve.png")
