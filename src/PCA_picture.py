...
def get_data():
    faces = fetch_olivetti_faces(data_home="data/pic")
    x = faces.data
    y = faces.target
...
def best_k(x):
    ...
    plt.savefig("pics/pca_best_k.png")
...
def model_train(x_train, x_test, y_train, y_test):
    ...
    clf = GridSearchCV(
        SVC(kernel="rbf", class_weight="balanced"), params, verbose=2, n_jobs=4
    )
